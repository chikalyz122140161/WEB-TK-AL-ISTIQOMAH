...
@section('content')
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;flex-wrap:wrap;gap:8px;">
        <a href="{{ route('guru.laporan_bk') }}" class="ld-back" style="margin-bottom:0;">
        ...
        <a href="{{ route('guru.laporan_bk.edit', $laporan['id']) }}?week={{ $laporan['week'] }}"
           style="display:inline-flex;align-items:center;gap:6px;background:#FFF176;color:#3E2723;border:1.5px solid #e6db00;padding:8px 16px;border-radius:7px;font-size:13px;font-weight:700;text-decoration:none;">
