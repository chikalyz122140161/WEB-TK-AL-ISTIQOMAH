...
<a href="{{ route('guru.kehadiran.index') }}"
    class="sidebar__item {{ request()->routeIs('guru.kehadiran.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<a href="{{ route('guru.jadwal.index') }}"
    class="sidebar__item {{ request()->routeIs('guru.jadwal.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path fill-rule="evenodd"
...
<a href="{{ route('guru.rapot.index') }}"
    class="sidebar__item {{ request()->routeIs('guru.rapot.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path
            d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.337 49.948 49.948 0 0 0-9.902 3.912l-.003.002c-.114.06-.227.119-.34.18a.75.75 0 0 1-.707 0A50.88 50.88 0 0 0 7.5 12.173v-.224c0-.131.067-.248.172-.311a54.615 54.615 0 0 1 4.653-2.52.75.75 0 0 0-.65-1.352 56.123 56.123 0 0 0-4.78 2.589 1.858 1.858 0 0 0-.859 1.228 49.803 49.803 0 0 0-4.634-1.527.75.75 0 0 1-.231-1.337A60.653 60.653 0 0 1 11.7 2.805Z" />
        <path
            d="M13.06 15.473a48.45 48.45 0 0 1 7.666-3.282c.134 1.414.22 2.843.255 4.284a.75.75 0 0 1-.46.711 47.87 47.87 0 0 0-8.105 4.342.75.75 0 0 1-.832 0 47.87 47.87 0 0 0-8.104-4.342.75.75 0 0 1-.461-.71c.035-1.442.121-2.87.255-4.286a48.401 48.401 0 0 1 7.667 3.282 49.847 49.847 0 0 1 2.119.001Z" />
    </svg>
    Rapot Semester
</a>
...
<a href="{{ route('guru.input_perkembangan') }}"
    class="sidebar__item {{ request()->routeIs('guru.input_perkembangan') || request()->routeIs('guru.store_input_perkembangan') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path
...
<a href="{{ route('guru.laporan_bk') }}"
    class="sidebar__item {{ request()->routeIs('guru.laporan_bk') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path fill-rule="evenodd"
...
<a href="{{ route('guru.jadwal_konseling') }}"
    class="sidebar__item {{ request()->routeIs('guru.jadwal_konseling') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path fill-rule="evenodd"
            d="M6.75 2.25A.75.75 0 0 1 7.5 3v1.5h9V3a.75.75 0 0 1 1.5 0v1.5h.75a3 3 0 0 1 3 3v11.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V7.5a3 3 0 0 1 3-3H6V3a.75.75 0 0 1 .75-.75Zm13.5 9a1.5 1.5 0 0 0-1.5-1.5H5.25a1.5 1.5 0 0 0-1.5 1.5v7.5a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-7.5Z"
            clip-rule="evenodd" />
