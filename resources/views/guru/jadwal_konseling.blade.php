...
@push('styles')
    <style>
        ...
        .aksi-catatan {
            background: rgba(61, 155, 114, 0.1);
            color: #2E8B60;
            border: 1px solid rgba(61, 155, 114, 0.25);
        }

        .aksi-catatan:hover {
            background: rgba(61, 155, 114, 0.2);
        }
...
@section('content')
    ...
    {{-- Toolbar --}}
    <div class="toolbar">
        <a href="{{ route('guru.jadwal_konseling.create_siswa') }}" class="btn-new btn-new--primary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <path
                    d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5ZM20 21h1.5a.5.5 0 0 0 .5-.5C22 17.57 18.43 14 14.5 14h-5C5.57 14 2 17.57 2 20.5a.5.5 0 0 0 .5$.5H20Z" />
            </svg>
            BUAT JADWAL PER SISWA
        </a>

        <a href="{{ route('guru.jadwal_konseling.create_kelas') }}" class="btn-new btn-new--secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <path fill-rule="evenodd"
                    d="M4.125 3C3.089 3 2.25 3.84 2.25 4.875V18a3 3 0 0 0 3 3h15a.75.75 0 0 0 0-1.5h-15a1.5 1.5 0 0 1-1.5-1.5V4.875c0-.207.168-.375.375-.375h15.75c.207 0 .375.168.375.375V12a.75.75 0 0 0 1.5 0V4.875C21.75 3.839 20.911 3 19.875 3H4.125Z"
                    clip-rule="evenodd" />
                <path d="M16.5 16.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            </svg>
            BUAT JADWAL PER KELAS
        </a>

        <form method="GET" action="{{ route('guru.jadwal_konseling') }}" class="form-jadwal--konseling">

            <input class="filter-select" type="month" name="bulan_tahun" value="{{ request('bulan_tahun', date('Y-m')) }}"
                style="min-width:160px;padding:0 12px;">

            <button type="submit" class="btn-new">Terapkan</button>
                ...
                @forelse ($jadwal as $i => $row)
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($tipe === 'per_kelas')
                                <span
                                    style="font-size:10px;font-weight:700;padding:3px 9px;border-radius:99px;background:rgba(62,39,35,0.08);color:#5D4037;border:1px solid rgba(62,39,35,0.18);white-space:nowrap;">
                                    PER KELAS
                                </span>
                            @elseif ($tipe === 'pengajuan')
                                <span
                                    style="font-size:10px;font-weight:700;padding:3px 9px;border-radius:99px;background:#FFF176;color:#5D4037;border:1px solid #e6db00;white-space:nowrap;">
                                    PENGAJUAN
                                </span>
                            @else
                                <span
                                    style="font-size:10px;font-weight:700;padding:3px 9px;border-radius:99px;background:rgba(76,175,130,0.15);color:#2E8B60;border:1px solid rgba(76,175,130,0.4);white-space:nowrap;">
                                    PER SISWA
                                </span>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            @if (($row['tipe'] ?? '') === 'per_kelas')
                                <span style="display:block;font-size:11px;color:#5D4037;opacity:.7;margin-top:1px;">Seluruh
                                    kelas</span>
                            @endif
                        </td>
                        <td>{{ $row['topik'] }}</td>
