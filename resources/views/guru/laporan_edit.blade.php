...
@push('styles')
    <style>
        ...
        .btn-save:hover {
            ...
            box-shadow: 0 5px 14px rgba(61, 155, 114, 0.4);
        }
                ...
                <div class="field-grid">
                    <div class="field-group">
                        ...
                        <input class="field-control" type="text"
                            value="{{ $laporan['semester'] }} — Kelas {{ $laporan['kelas'] }}" readonly>
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input class="field-control" type="date" name="tanggal" value="{{ $laporan['tanggal'] }}"
                            required>
                    </div>
                </div>
            </div>
                                ...
                                <div class="assessment-row">
                                    ...
                                    <div class="assessment-row__select">
                                        <select name="counseling[{{ $kon['id'] }}][{{ $item['id'] }}]"
                                            class="field-control {{ $cls }}" onchange="updateSelectStyle(this)">
                                            <option value="">-- Pilih Level --</option>
                                            <option value="BB" {{ $kode === 'BB' ? 'selected' : '' }}>BB — Belum
                                                Berkembang</option>
                                            <option value="MB" {{ $kode === 'MB' ? 'selected' : '' }}>MB — Mulai
                                                Berkembang</option>
                                            <option value="BSH" {{ $kode === 'BSH' ? 'selected' : '' }}>BSH — Berkembang
                                                Sesuai Harapan</option>
                                            <option value="BSB" {{ $kode === 'BSB' ? 'selected' : '' }}>BSB — Berkembang
                                                Sangat Baik</option>
                                        </select>
                                    </div>
                                </div>
