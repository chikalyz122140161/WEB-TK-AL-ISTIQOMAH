...
@section('content')
    ...
    <div class="info-banner">
        <div class="info-banner__avatar">{{ strtoupper(substr($rapot['siswa']['nama'], 0, 1)) }}</div>
        <div class="info-banner__content">
            <h2 class="info-banner__name">{{ $rapot['siswa']['nama'] }}</h2>
            <div class="info-banner__detail">
                <span>{{ $rapot['kelas'] }}</span>
                <span>{{ $rapot['tahun_ajaran'] }}</span>
                <span>Semester {{ $rapot['semester'] }}</span>
            </div>
        </div>
        <span class="info-banner__status {{ $rapot['status'] == 'Terbit' ? 'terbit' : '' }}">{{ $rapot['status'] }}</span>
    </div>

    <form action="{{ route('guru.rapot.update', $rapot['id']) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tahun_ajaran" required>
                            ...
                            <option value="2024/2025" {{ $rapot['tahun_ajaran'] == '2024/2025' ? 'selected' : '' }}>2024/2025</option>
                            <option value="2023/2024" {{ $rapot['tahun_ajaran'] == '2023/2024' ? 'selected' : '' }}>2023/2024</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Semester <span class="required">*</span></label>
                        <select name="semester" required>
                            <option value="Ganjil" {{ $rapot['semester'] == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                            <option value="Genap" {{ $rapot['semester'] == 'Genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Terbit</label>
                        <input type="date" name="tanggal_terbit" value="{{ $rapot['tanggal_terbit'] ? date('Y-m-d', strtotime($rapot['tanggal_terbit'])) : '' }}">
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="agama_moral" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['agama_moral'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['agama_moral'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['agama_moral'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['agama_moral'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="agama_moral_deskripsi" placeholder="Tuliskan deskripsi perkembangan anak pada aspek agama dan moral...">{{ $rapot['nilai']['agama_moral_deskripsi'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="fisik_motorik" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['fisik_motorik'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['fisik_motorik'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['fisik_motorik'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['fisik_motorik'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="fisik_motorik_deskripsi" placeholder="Tuliskan deskripsi perkembangan fisik motorik anak...">{{ $rapot['nilai']['fisik_motorik_deskripsi'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="kognitif" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['kognitif'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['kognitif'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['kognitif'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['kognitif'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="kognitif_deskripsi" placeholder="Tuliskan deskripsi perkembangan kognitif anak...">{{ $rapot['nilai']['kognitif_deskripsi'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="bahasa" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['bahasa'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['bahasa'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['bahasa'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['bahasa'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="bahasa_deskripsi" placeholder="Tuliskan deskripsi perkembangan bahasa anak...">{{ $rapot['nilai']['bahasa_deskripsi'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="sosial_emosional" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['sosial_emosional'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['sosial_emosional'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['sosial_emosional'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['sosial_emosional'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="sosial_emosional_deskripsi" placeholder="Tuliskan deskripsi perkembangan sosial emosional anak...">{{ $rapot['nilai']['sosial_emosional_deskripsi'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="nilai-section">
                    <div class="nilai-section__header">
                        ...
                        <select name="seni" class="nilai-select" required>
                            <option value="BB" {{ $rapot['nilai']['seni'] == 'BB' ? 'selected' : '' }}>BB - Belum Berkembang</option>
                            <option value="MB" {{ $rapot['nilai']['seni'] == 'MB' ? 'selected' : '' }}>MB - Mulai Berkembang</option>
                            <option value="BSH" {{ $rapot['nilai']['seni'] == 'BSH' ? 'selected' : '' }}>BSH - Berkembang Sesuai Harapan</option>
                            <option value="BSB" {{ $rapot['nilai']['seni'] == 'BSB' ? 'selected' : '' }}>BSB - Berkembang Sangat Baik</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
            ...
            <div class="form-card__body">
                <div class="form-grid full">
                    <div class="form-group">
                        ...
                        <textarea name="catatan_guru" rows="4" placeholder="Tuliskan catatan umum tentang perkembangan anak selama semester ini...">{{ $rapot['catatan_guru'] }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Rekomendasi</label>
                        <textarea name="rekomendasi" rows="4" placeholder="Tuliskan rekomendasi untuk orang tua dalam mendukung perkembangan anak...">{{ $rapot['rekomendasi'] }}</textarea>
                    </div>
                </div>
