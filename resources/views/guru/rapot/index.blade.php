...
@push('styles')
    <style>
        ...
        .rapot-table tbody tr:last-child td {
            border-bottom: none;
        }

        .rapot-table tbody tr:hover td {
            background: #fafafa;
        }
        ...
        .ct-status-pill--aktif {
            background: rgba(76, 175, 130, 0.15);
            color: #2E8B60;
        }

        .ct-status-pill--selesai {
            background: rgba(62, 39, 35, 0.08);
            color: #5D4037;
        }

        .ct-status-pill--menunggu {
            background: #FFF176;
            color: #5D4037;
        }
        ...
        .btn-input:hover {
            ...
            box-shadow: 0 4px 10px rgba(61, 155, 114, 0.3);
        }
                        ...
                        <tbody>
                            @foreach ($terms as $i => $ct)
                                @php
                                    $pct =
                                        $ct['total_siswa'] > 0
                                            ? round(($ct['sudah_rapot'] / $ct['total_siswa']) * 100)
                                            : 0;
                                @endphp
                                <tr>
