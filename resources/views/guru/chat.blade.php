...
@section('title', 'Chat - SISTEM BK TK AL-ISTIQOMAH')
...
<style>
    ...
    .chat-contact.active { background: #065F46; }
    .chat-contact__name {
        font-size: 13px;
        font-weight: 700;
        color: #111827;
    ...
    .chat-input__send:hover { background: #064E3B; }
</style>
@endpush
...
@section('sidebar')
    ...
    <a href="{{ route('guru.chat') }}" class="sidebar__item active">
