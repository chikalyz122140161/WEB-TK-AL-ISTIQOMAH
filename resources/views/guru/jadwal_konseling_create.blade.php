...
<style>
    .back-link {
        ...
        font-size: 13px; font-weight: 500; color: #5D4037;
    ...
    .section-header__icon svg { width: 22px; height: 22px; fill: #fff; }
    .section-header__text h2 {
        font-size: 17px; font-weight: 700; color: #3E2723; margin: 0;
    }
    .section-header__text p {
        font-size: 12px; color: #5D4037; margin: 2px 0 0;
    }
    ...
    .info-alert svg {
        ...
        fill: #2E8B60; flex-shrink: 0; margin-top: 2px;
    }
    ...
    .form-group label span.req { color: #F06292; }
    .form-group input,
    .form-group select,
    .form-group textarea {
        padding: 10px 14px;
...
@section('content')
    ...
    <div class="info-alert">
        ...
        <div>
            ...
            @if ($mode === 'kelas')
                <strong>Mode Per Kelas:</strong> satu form ini akan men-generate jadwal terpisah untuk setiap siswa di class term yang dipilih.
            @endif
        </div>
    </div>
...
function updateSiswa() {
    ...
    var ct = CLASS_TERMS.find(function(c){ return c.id === ctId; });
