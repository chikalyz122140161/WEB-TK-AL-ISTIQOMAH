...
@section('content')
    ...
    <div class="konseling-container">
        {{-- Section Header --}}
        <div style="display:flex;align-items:center;justify-content:flex-end;gap:12px;margin-bottom:18px;flex-wrap:wrap;">
        ...
        @if (session('success'))
            <div
                style="background:rgba(76,175,130,0.12);border:1px solid rgba(76,175,130,0.3);border-radius:8px;padding:12px 16px;margin-bottom:16px;font-size:13px;color:#2E8B60;display:flex;align-items:center;gap:10px;">
        ...
        @if (session('error'))
            <div
                style="background:#F0629220;border:1px solid #F0629240;border-radius:8px;padding:12px 16px;margin-bottom:16px;font-size:13px;color:#d81b72;display:flex;align-items:center;gap:10px;">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18"
                    height="18">
                    <path fill-rule="evenodd"
        ...
        <div class="info-alert">
            ...
            <div class="info-alert__text">
                ...
                Setelah pengajuan disetujui, Anda akan mendapat notifikasi melalui email.
            </div>
        </div>
        ...
        <div class="history-card">
            <div class="history-card__header">
                <h3 class="history-card__title" style="display:inline-flex;align-items:center;gap:8px;">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3D9B72" width="18"
                        height="18">
                        <path fill-rule="evenodd"
                ...
                <span
                    style="font-size:11px;color:#5D4037;background:rgba(76,175,130,0.12);padding:3px 10px;border-radius:99px;border:1px solid rgba(76,175,130,0.3);font-weight:600;">
                            ...
                            <td style="text-align:center;">
                                @if ($jadwal['status'] === 'pending')
                                    <div class="aksi-btns" style="justify-content:center;">
                                        ...
                                        <form method="POST"
                                            action="{{ route('orangtua.konseling.batal', $jadwal['id']) }}"
                                            style="margin:0;"
                                            onsubmit="return confirm('Batalkan pengajuan konseling ini?')">
                                            @csrf @method('DELETE')
