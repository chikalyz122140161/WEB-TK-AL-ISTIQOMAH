...
<div class="grafik-container">
    ...
    <div class="summary-row">
        <div class="summary-card">
            ...
            <div class="summary-card__value">4.2</div>
            <div class="summary-card__trend summary-card__trend--up">↑ +0.3</div>
        </div>
        <div class="summary-card">
            ...
            <div class="summary-card__value">4.5</div>
            <div class="summary-card__trend summary-card__trend--up">↑ +0.5</div>
        </div>
        <div class="summary-card">
            ...
            <div class="summary-card__value">4.8</div>
            <div class="summary-card__trend summary-card__trend--up">↑ +0.2</div>
        </div>
        <div class="summary-card">
            ...
            <div class="summary-card__value">3.8</div>
            <div class="summary-card__trend summary-card__trend--neutral">→ 0</div>
        </div>
        <div class="summary-card">
            ...
            <div class="summary-card__value">4.3</div>
            <div class="summary-card__trend summary-card__trend--up">↑ +0.1</div>
        </div>
        <div class="summary-card">
            ...
            <div class="summary-card__value">4.0</div>
            <div class="summary-card__trend summary-card__trend--down">↓ -0.1</div>
        </div>
    </div>
    ...
    <div class="chart-card">
        <div class="chart-card__header">
            <h3 class="chart-card__title">Grafik Perkembangan 3 Bulan Terakhir</h3>
...
<script>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Fisik-Motorik',
                    data: [3.5, 3.6, 3.8, 3.9, 4.0, 4.0, 4.1, 4.0, 4.2, 4.1, 4.2, 4.2],
                    borderColor: '#EF4444',
                ...
                {
                    label: 'Kognitif',
                    data: [3.8, 4.0, 4.1, 4.2, 4.3, 4.3, 4.4, 4.4, 4.5, 4.5, 4.5, 4.5],
                    borderColor: '#F59E0B',
                ...
                {
                    label: 'Bahasa',
                    data: [4.0, 4.2, 4.3, 4.4, 4.5, 4.6, 4.6, 4.7, 4.7, 4.8, 4.8, 4.8],
                    borderColor: '#10B981',
                ...
                },
                {
                    ...
                    data: [3.5, 3.5, 3.6, 3.6, 3.7, 3.7, 3.8, 3.8, 3.8, 3.8, 3.8, 3.8],
                    borderColor: '#3B82F6',
                ...
                {
                    label: 'Agama & Moral',
                    data: [3.8, 3.9, 4.0, 4.0, 4.1, 4.1, 4.2, 4.2, 4.2, 4.3, 4.3, 4.3],
                    borderColor: '#8B5CF6',
                ...
                {
                    label: 'Seni',
                    data: [3.8, 3.9, 4.0, 4.0, 4.1, 4.1, 4.1, 4.0, 4.0, 4.0, 4.0, 4.0],
                    borderColor: '#EC4899',
    ...
    new Chart(radarCtx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Rata-rata',
                data: [4.2, 4.5, 4.8, 3.8, 4.3, 4.0],
                fill: true,
                backgroundColor: 'rgba(250, 174, 43, 0.2)',
                borderColor: '#faae2b',
                pointBackgroundColor: '#faae2b',
                pointBorderColor: '#fff',
                pointHoverBackgroundColor: '#fff',
                pointHoverBorderColor: '#faae2b'
            }]
        },
        options: {
            responsive: true,
