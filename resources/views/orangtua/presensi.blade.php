...
@push('styles')
    <style>
        ...
        .presensi-stat__value--green {
            color: #2E8B60;
        }

        .presensi-stat__value--amber {
            color: #5D4037;
        }

        .presensi-stat__value--blue {
            color: #2E8B60;
        }

        .presensi-stat__value--red {
            color: #d81b72;
        }

        .presensi-stat__value--teal {
            color: #3E2723;
        }
...
@section('content')
    ...
    @if (is_null($student['id']))
        <div class="not-connected-state">
            ...
            <p>Akun Anda belum terhubung dengan data siswa manapun.<br>Silakan hubungi administrator sekolah untuk
                menghubungkan akun Anda.</p>
        </div>
    @else
        {{-- Filter --}}
            ...
            <div class="filter-group">
                ...
                <select name="class_term_id" id="selectClassTerm">
                    @foreach ($classTerms as $ct)
                        <option value="{{ $ct['id'] }}" data-bulan="{{ json_encode($ct['bulan_aktif']) }}"
        ...
        <div class="detail-section">
            <div class="detail-section__header">
                Detail Kehadiran <span style="color:#2E8B60; font-weight:800;">{{ $student['nama'] ?? 'Tidak ada nama' }}</span> {{ $namaBulan }} {{ $tahun }}
                <br>
        ...
        <script>
            ...
            (function() {
                var BULAN_NAMA = ['', 'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus',
