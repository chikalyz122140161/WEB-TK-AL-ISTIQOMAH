...
<div class="card">
    <div class="card__header">
        ...
        <span class="badge badge--primary">{{ $ekstrakurikuler->count() }} Ekstrakurikuler</span>
    </div>
        ...
        <table class="ekskul-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="ekskul-name">{{ $e->name }}</span>
                        <span class="poin-count">{{ $e->assessments->count() }} poin</span>
                    </td>
                    <td>
                        @if($e->assessments->isEmpty())
                            <span class="poin-empty">Belum ada poin penilaian</span>
                        @else
                            <div class="poin-chips">
                                @foreach($e->assessments as $p)
                    ...
                    <td>
                        <div class="btn-row">
                            ...
                            <button type="button" class="btn btn--danger btn--sm"
                                    onclick="showDeleteModal('{{ $e->id }}', '{{ $e->name }}')">
