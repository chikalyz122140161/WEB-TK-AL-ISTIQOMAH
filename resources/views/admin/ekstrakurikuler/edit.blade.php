...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title">Edit Ekstrakurikuler {{ $ekstrakurikuler->nama }}</h1>
        <p class="page-header__subtitle">Perbarui ekstrakurikuler dan poin penilaiannya</p>
    </div>
...
<div class="card">
    <div class="card__header">
        <h3 class="card__title">Form Edit Ekstrakurikuler</h3>
    </div>
    <div class="card__body">
        <form action="{{ route('admin.ekstrakurikuler.update', $ekstrakurikuler->id) }}" method="POST" class="form" id="ekskul-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-actions" style="margin-top: 1.5rem;">
                ...
                <button type="submit" class="btn btn--primary">Perbarui Ekstrakurikuler</button>
            </div>
        </form>
    </div>
</div>
