...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title">Tambah Konseling</h1>
        <p class="page-header__subtitle">Tambah jenis konseling beserta poin penilaiannya</p>
    </div>
...
<div class="card">
    <div class="card__header">
        <h3 class="card__title">Form Konseling</h3>
    </div>
    <div class="card__body">
        <form action="{{ route('admin.konseling.store') }}" method="POST" class="form" id="konseling-form">
            @csrf

            <div class="form-group">
                <label for="nama" class="form-label required">Nama Konseling</label>
                <input type="text" id="nama" name="nama" class="form-input"
                    value="{{ old('nama') }}" placeholder="Contoh: Konseling Sosial-Emosional, Konseling Belajar" required maxlength="100">
            </div>
            ...
            <div class="form-actions" style="margin-top: 1.5rem;">
                ...
                <button type="submit" class="btn btn--primary">Simpan Konseling</button>
            </div>
        </form>
    </div>
</div>
