...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title">Tambah Mata Pelajaran</h1>
        <p class="page-header__subtitle">Tambah data mata pelajaran baru</p>
    </div>
...
<div class="card">
    <div class="card__header">
        <h3 class="card__title">Form Mata Pelajaran</h3>
    </div>
    <div class="card__body">
        <form action="{{ route('admin.mata_pelajaran.store') }}" method="POST" class="form">
            @csrf

            <div class="form-group">
                <label for="nama" class="form-label required">Nama Mata Pelajaran</label>
                <input type="text" id="nama" name="nama" class="form-input"
                    value="{{ old('nama') }}" placeholder="Contoh: Sentra Balok, Bahasa Indonesia" required maxlength="100">
            </div>
