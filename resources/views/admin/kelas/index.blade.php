                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-row">
                            ...
                            <form id="del-form-{{ $k->id }}" action="{{ route('admin.kelas.destroy', $k->id) }}" method="POST" style="display:none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            <button type="button" class="btn btn--danger btn--sm"
                                onclick="confirmHapus('{{ $k->id }}', '{{ $k->name }}')">
...
function confirmHapus(id, nama) {
    _hapusFormId = id;
    document.getElementById('hapusModalDesc').textContent = 'Kelas ' + nama + ' akan dihapus secara permanen.';
