...
<a href="{{ route('admin.tahun_ajaran.index') }}" class="sidebar__item {{ request()->routeIs('admin.tahun_ajaran.*') ? 'active' : '' }}">
...
<a href="{{ route('admin.kelas.index') }}" class="sidebar__item {{ request()->routeIs('admin.kelas.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11.7 2.805a.75.75 0 0 1 .6 0A60.65 60.65 0 0 1 22.83 8.72a.75.75 0 0 1-.231 1.337 49.948 49.948 0 0 0-9.902 3.912l-.003.002-.34.18a.75.75 0 0 1-.707 0A50.88 50.88 0 0 0 4.8 11.06a.75.75 0 0 1-.231-1.337A60.65 60.65 0 0 1 11.7 2.805Z"/><path d="M6 16.5a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0v-3.75a.75.75 0 0 1 .75-.75Zm9.75 0a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0v-3.75a.75.75 0 0 1 .75-.75Zm-3.75 3a3.75 3.75 0 0 1-3.75-3.75V14.2a1.5 1.5 0 0 1 .885-1.362l.5-.24a1.5 1.5 0 0 1 1.23 0l.5.24A1.5 1.5 0 0 1 12 14.2v1.55a3.75 3.75 0 0 1-3.75 3.75Zm0-2.25a1.5 1.5 0 0 0 1.5-1.5V14.2l-.5-.24a.25.25 0 0 0-.2 0l-.5.24v1.55a1.5 1.5 0 0 0 1.5 1.5Z"/><path fill-rule="evenodd" d="M3.019 11.114a.75.75 0 0 1 .853.604 49.77 49.77 0 0 0 3.846 13.4.75.75 0 1 1-1.346.666A51.27 51.27 0 0 1 2.415 11.967a.75.75 0 0 1 .604-.853Z" clip-rule="evenodd"/><path fill-rule="evenodd" d="M20.981 11.114a.75.75 0 0 1 .604.853 51.27 51.27 0 0 1-3.957 13.817.75.75 0 0 1-1.346-.666 49.77 49.77 0 0 0 3.846-13.4.75.75 0 0 1 .853-.604Z" clip-rule="evenodd"/></svg>
    Kelola Kelas
</a>
<a href="{{ route('admin.ekstrakurikuler.index') }}" class="sidebar__item {{ request()->routeIs('admin.ekstrakurikuler.*') ? 'active' : '' }}">
...
<a href="{{ route('admin.mata_pelajaran.index') }}" class="sidebar__item {{ request()->routeIs('admin.mata_pelajaran.*') ? 'active' : '' }}">
...
<a href="{{ route('admin.konseling.index') }}" class="sidebar__item {{ request()->routeIs('admin.konseling.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M9 4.5a.75.75 0 0 1 .721.544l.813 2.846a3.75 3.75 0 0 0 2.576 2.576l2.846.813a.75.75 0 0 1 0 1.442l-2.846.813a3.75 3.75 0 0 0-2.576 2.576l-.813 2.846a.75.75 0 0 1-1.442 0l-.813-2.846a3.75 3.75 0 0 0-2.576-2.576l-2.846-.813a.75.75 0 0 1 0-1.442l2.846-.813A3.75 3.75 0 0 0 7.466 7.89l.813-2.846A.75.75 0 0 1 9 4.5ZM18 1.5a.75.75 0 0 1 .728.568l.258 1.036c.236.94.97 1.674 1.91 1.91l1.036.258a.75.75 0 0 1 0 1.456l-1.036.258c-.94.236-1.674.97-1.91 1.91l-.258 1.036a.75.75 0 0 1-1.456 0l-.258-1.036a2.625 2.625 0 0 0-1.91-1.91l-1.036-.258a.75.75 0 0 1 0-1.456l1.036-.258a2.625 2.625 0 0 0 1.91-1.91l.258-1.036A.75.75 0 0 1 18 1.5ZM16.5 15a.75.75 0 0 1 .712.513l.394 1.183c.15.447.5.799.948.948l1.183.395a.75.75 0 0 1 0 1.422l-1.183.395c-.447.15-.799.5-.948.948l-.395 1.183a.75.75 0 0 1-1.422 0l-.395-1.183a1.5 1.5 0 0 0-.948-.948l-1.183-.395a.75.75 0 0 1 0-1.422l1.183-.395c.447-.15.799-.5.948-.948l.395-1.183A.75.75 0 0 1 16.5 15Z" clip-rule="evenodd"/></svg>
    Kelola Konseling
</a>
<a href="{{ route('admin.aktivitas_tahun_ajaran.index') }}" class="sidebar__item {{ request()->routeIs('admin.aktivitas_tahun_ajaran.*') ? 'active' : '' }}">
...
<a href="{{ route('admin.kenaikan.index') }}" class="sidebar__item {{ request()->routeIs('admin.kenaikan.*') ? 'active' : '' }}">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M11.47 4.72a.75.75 0 0 1 1.06 0l3.75 3.75a.75.75 0 0 1-1.06 1.06L12.75 7.06V19.5a.75.75 0 0 1-1.5 0V7.06L9.53 8.78a.75.75 0 0 1-1.06-1.06l3.75-3.75Zm-5.03 9.28a.75.75 0 0 1 0 1.06l-1.5 1.5a.75.75 0 0 1-1.06-1.06l1.5-1.5a.75.75 0 0 1 1.06 0Zm9.56 0a.75.75 0 0 1 1.06 0l1.5 1.5a.75.75 0 1 1-1.06 1.06l-1.5-1.5a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd"/></svg>
    Kenaikan Siswa
</a>
