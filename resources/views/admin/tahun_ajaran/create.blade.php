...
<div class="page-header">
    <div class="page-header__left">
        <h1 class="page-header__title">Tambah Tahun Ajaran</h1>
        <p class="page-header__subtitle">Tambah data tahun ajaran dan semester baru</p>
    </div>
...
<div class="card" style="max-width:560px;">
    <div class="card__header">
        <h3 class="card__title">Form Tahun Ajaran</h3>
    </div>
    <div class="card__body">
        <form action="{{ route('admin.tahun_ajaran.store') }}" method="POST" class="form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="tahun_ajaran" name="tahun_ajaran" class="form-input"
                    value="{{ old('tahun_ajaran') }}" placeholder="contoh: 2025/2026" required>
            </div>
