...
class ErdSeeder extends Seeder
{
    public function run(): void
    {
        ...
        /* ══════════════════════════════════════════════════
         *  3. SISWA (50) + AKUN ORANG TUA
         *     Semua akun orangtua berstatus 'pending'
         *     Tidak ada enrollment / penempatan kelas
         * ══════════════════════════════════════════════════ */
        foreach ($this->getSiswaData() as $idx => $row) {
        ...
        $total = count($this->getSiswaData());
        $this->command->info('✓ Seeder selesai:');
        $this->command->info('  • 1 Admin + 3 Guru');
        $this->command->info("  • {$total} siswa + {$total} akun orang tua (status: pending)");
        $this->command->info('  • Belum ada penempatan kelas');
    }
    ...
    private function getSiswaData(): array
    {
        return [
            // 1–11 (data asli)
            ['nis' => '121', 'nisn' => '3202858632', 'name' => 'ALVARO ATHAYA ARIYUN', 'gender' => 'L',
            ...
            ['nis' => '144', 'nisn' => '3201575054', 'name' => 'M. RAFFA ALFATIH AFRIYADI', 'gender' => 'L',
            ...
            ['nis' => null, 'nisn' => '3219058996', 'name' => 'MAHENDRA ANDRIAN', 'gender' => 'L',
            ...
            ['nis' => '148', 'nisn' => '3203532466', 'name' => 'MUHAMMAD AMMAR FADHILAH', 'gender' => 'L',
            ...
            ['nis' => '145', 'nisn' => '3205821892', 'name' => 'MUHAMMAD MIKAIL WIJAYA', 'gender' => 'L',
            ...
            ['nis' => '133', 'nisn' => '3211693324', 'name' => 'MUHAMMAD ZABDAN ANDRIAN', 'gender' => 'L',
            ...
            ['nis' => '146', 'nisn' => '3201201694', 'name' => 'REINA MECCA KURNIAWAN', 'gender' => 'P',
            ...
            ['nis' => null, 'nisn' => '3218872635', 'name' => 'YUKI MAHARANI', 'gender' => 'P',
            ...
            ['nis' => '147', 'nisn' => '3208775515', 'name' => 'ZEVANYA KIMBERLY', 'gender' => 'P',
            ...
            ['nis' => '149', 'nisn' => null, 'name' => 'ERLANGGA PRADIPTA BIMANTARA', 'gender' => 'L',
            ...
            ['nis' => '150', 'nisn' => null, 'name' => 'ISHKA AGNIA', 'gender' => 'P',
            ...
            // 12–25 (data asli)
            ['nis' => '119', 'nisn' => '3193713608', 'name' => 'ABIL ALTAIR ERDHAFEN', 'gender' => 'L',
            ...
            ['nis' => '120', 'nisn' => '3196671765', 'name' => 'AISYAH PUTRI INAYAH', 'gender' => 'P',
            ...
            ['nis' => '122', 'nisn' => '3207566962', 'name' => 'AKSYAHRA VYANTA HUMAIRA MECCA', 'gender' => 'P',
            ...
            ['nis' => '125', 'nisn' => '3208035104', 'name' => 'AQILA ZALFA HASANAH', 'gender' => 'P',
            ...
            ['nis' => '127', 'nisn' => '3191726611', 'name' => 'ARSYILA RAFIFAH ADELIA', 'gender' => 'P',
            ...
            ['nis' => '123', 'nisn' => '3198334668', 'name' => 'ATHALLA MAHER', 'gender' => 'L',
            ...
            ['nis' => '128', 'nisn' => '3199983429', 'name' => 'CHEISYA SALSABILA', 'gender' => 'P',
            ...
            ['nis' => '130', 'nisn' => '3192155289', 'name' => 'DEWI HAFIZAH IRWANA', 'gender' => 'P',
            ...
            ['nis' => '129', 'nisn' => '3195197158', 'name' => 'DIRGA ANDRIAN', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2019-12-17', 'nik' => '1871141712190003',
             'address' => 'Komp Perum Pancabakti No 63', 'phone' => '088286242966',
             'ayah_nama' => 'Andrian Suryana', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Kencana Wulan Sari', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => '131', 'nisn' => '3193605334', 'name' => 'MARYAM GEBRINA KUSUMA', 'gender' => 'P',
            ...
            ['nis' => '137', 'nisn' => '3199561634', 'name' => 'REYHAN ALFA RISKI', 'gender' => 'L',
            ...
            ['nis' => '141', 'nisn' => '3206973252', 'name' => 'SYAFIQ RADEVA VERDIANTO', 'gender' => 'L',
            ...
            ['nis' => '142', 'nisn' => '3207434745', 'name' => 'TEGUH SATRIA', 'gender' => 'L',
            ...
            ['nis' => '143', 'nisn' => '3191730870', 'name' => 'WILDAN AMRILAH', 'gender' => 'L',
            ...
            // 26–36 (data asli)
            ['nis' => null, 'nisn' => '3200671971', 'name' => 'ANDHANU RHADITYA', 'gender' => 'L',
            ...
            ['nis' => '126', 'nisn' => null, 'name' => 'ARRASYA NATHANAEL WIDIANTO', 'gender' => 'L',
            ...
            ['nis' => '132', 'nisn' => '3209801539', 'name' => 'KHAIRA NADHIFA SATRIYA JASA', 'gender' => 'P',
            ...
            ['nis' => '134', 'nisn' => '3196466268', 'name' => 'LUTHPI HASBI', 'gender' => 'L',
            ...
            ['nis' => '138', 'nisn' => '3209376025', 'name' => 'NAUFAL RAMADHAN', 'gender' => 'L',
            ...
            ['nis' => '135', 'nisn' => '3202483333', 'name' => 'NAYLA NANDA PUTRI', 'gender' => 'P',
            ...
            ['nis' => '139', 'nisn' => '3206861787', 'name' => 'RENATA ARSY SUSILO', 'gender' => 'P',
            ...
            ['nis' => '140', 'nisn' => '3208144690', 'name' => 'SALAHUDDIN KAHFI PRAWIRANEGARA', 'gender' => 'L',
            ...
            ['nis' => '136', 'nisn' => '3192524958', 'name' => 'SHEZAN NAILA SALSABILA', 'gender' => 'P',
            ...
            // 37–50 (siswa baru)
            ['nis' => null, 'nisn' => null, 'name' => 'AZKA FATIH RAMADHAN', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-07-12', 'nik' => null,
             'address' => 'Jl. Teuku Umar No. 45 LK I', 'phone' => '082145678901',
             'ayah_nama' => 'Rizki Ramadhan', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Siti Nurhaliza', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'NABILA ZAHRA AULIA', 'gender' => 'P',
             'pob' => 'Bandar Lampung', 'dob' => '2020-05-20', 'nik' => null,
             'address' => 'Jl. Diponegoro Gg. Melati No. 12', 'phone' => '085312345678',
             'ayah_nama' => 'Dedi Setiawan', 'ayah_kerja' => 'Wiraswasta',
             'ibu_nama' => 'Rina Wati', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'HAFIDZ MAULANA IBRAHIM', 'gender' => 'L',
             'pob' => 'Metro', 'dob' => '2020-02-14', 'nik' => null,
             'address' => 'Jl. Ahmad Yani No. 78 LK III', 'phone' => '081298765432',
             'ayah_nama' => 'Ibrahim Sholeh', 'ayah_kerja' => 'PNS/TNI/Polri',
             'ibu_nama' => 'Fatimah', 'ibu_kerja' => 'Guru'],

            ['nis' => null, 'nisn' => null, 'name' => 'SITI AISYAH RAMADHANI', 'gender' => 'P',
             'pob' => 'Bandar Lampung', 'dob' => '2020-08-30', 'nik' => null,
             'address' => 'Jl. Raden Intan Gg. Kenanga No. 5', 'phone' => '089612345678',
             'ayah_nama' => 'Hendra Gunawan', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Yanti Ramadhani', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'FARHAN ADITYA PRATAMA', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-04-05', 'nik' => null,
             'address' => 'Jl. Pajajaran No. 22 LK II',
             'ayah_nama' => 'Budi Pratama', 'ayah_kerja' => 'Buruh',
             'ibu_nama' => 'Lia Susanti', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'ZAHRA NURUL IZZAH', 'gender' => 'P',
             'pob' => 'Pringsewu', 'dob' => '2020-09-17', 'nik' => null,
             'address' => 'Jl. Soekarno Hatta Gg. Mawar No. 3', 'phone' => '082356781234',
             'ayah_nama' => 'Wahyu Hidayat', 'ayah_kerja' => 'Wiraswasta',
             'ibu_nama' => 'Dewi Lestari', 'ibu_kerja' => 'IRT'],

            ['nis' => null, 'nisn' => null, 'name' => 'RAFI AHMAD FAUZAN', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-06-22', 'nik' => null,
             'address' => 'Jl. Sultan Agung No. 15 LK I', 'phone' => '081356789012',
             'ayah_nama' => 'Fauzan Hakim', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Novia Sari', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'KEYSHA AURELIA PUTRI', 'gender' => 'P',
             'pob' => 'Bandar Lampung', 'dob' => '2020-01-09', 'nik' => null,
             'address' => 'Jl. Kartini Gg. Anggrek No. 8', 'phone' => '085678901234',
             'ayah_nama' => 'Eko Purwanto', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Sri Wahyuni', 'ibu_kerja' => 'Guru'],

            ['nis' => null, 'nisn' => null, 'name' => 'DZAKY ARYA WIBOWO', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-11-03', 'nik' => null,
             'address' => 'Jl. Hasanuddin No. 34 LK II',
             'ayah_nama' => 'Arya Wibowo', 'ayah_kerja' => 'Wiraswasta',
             'ibu_nama' => 'Mega Lestari', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'AULIA SAFIRA RAHAYU', 'gender' => 'P',
             'pob' => 'Lampung Selatan', 'dob' => '2020-03-28', 'nik' => null,
             'address' => 'Jl. Imam Bonjol Gg. Dahlia No. 6', 'phone' => '082367890123',
             'ayah_nama' => 'Doni Rahayu', 'ayah_kerja' => 'Petani',
             'ibu_nama' => 'Indri Yani', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'KEVIN PRATAMA SANTOSO', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-10-14', 'nik' => null,
             'address' => 'Jl. Gatot Subroto No. 56 LK III', 'phone' => '089723456789',
             'ayah_nama' => 'Santoso', 'ayah_kerja' => 'Karyawan Swasta',
             'ibu_nama' => 'Linda Pratiwi', 'ibu_kerja' => 'Karyawan Swasta'],

            ['nis' => null, 'nisn' => null, 'name' => 'HANA NURAFIFAH', 'gender' => 'P',
             'pob' => 'Bandar Lampung', 'dob' => '2021-01-18', 'nik' => null,
             'address' => 'Jl. Mangga No. 12 LK I', 'phone' => '081234509876',
             'ayah_nama' => 'Syaifudin', 'ayah_kerja' => 'Buruh',
             'ibu_nama' => 'Afifah Rahmawati', 'ibu_kerja' => 'Tidak bekerja'],

            ['nis' => null, 'nisn' => null, 'name' => 'NABIL HAKIM MAULANA', 'gender' => 'L',
             'pob' => 'Bandar Lampung', 'dob' => '2020-12-25', 'nik' => null,
             'address' => 'Jl. Flamboyan Gg. Nusa Indah No. 9',
             'ayah_nama' => 'Hakim Maulana', 'ayah_kerja' => 'Wiraswasta',
             'ibu_nama' => 'Yeni Kurniasih', 'ibu_kerja' => 'IRT'],

            ['nis' => null, 'nisn' => null, 'name' => 'SYIFA AZZAHRA NURAINI', 'gender' => 'P',
             'pob' => 'Tanggamus', 'dob' => '2020-08-07', 'nik' => null,
             'address' => 'Jl. Pisang No. 4 LK II', 'phone' => '085612340987',
             'ayah_nama' => 'Nuraini Ahmad', 'ayah_kerja' => 'Petani',
             'ibu_nama' => 'Susi Rahayu', 'ibu_kerja' => 'Tidak bekerja'],
        ];
    }
}
